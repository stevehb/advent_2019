...
# codesStr = "3,52,1001,52,-5,52,3,53,1,52,56,54,1007,54,5,55,1005,55,26,1001,54,-5,54,1105,1,12,1,53,54,53,1008,54,0,55,1001,55,1,55,2,53,55,53,4,53,1001,56,-1,56,1005,56,6,99,0,0,0,0,10"
...
for phases in permutes:
    ...
    machineStates = [
        {"isFinished": False, "codes": codes.copy(), "instPtr": 0, "inputs": [phases[0], 0]},
        {"isFinished": False, "codes": codes.copy(), "instPtr": 0, "inputs": [phases[1]]},
        {"isFinished": False, "codes": codes.copy(), "instPtr": 0, "inputs": [phases[2]]},
        {"isFinished": False, "codes": codes.copy(), "instPtr": 0, "inputs": [phases[3]]},
        {"isFinished": False, "codes": codes.copy(), "instPtr": 0, "inputs": [phases[4]]}
    ]
    ...
    while(isLooping):
        ...
        for i in range(0, 5):
            ...
            # print(f"    [{i}]{machineStates[i]['codes']}")
            # print(f"    [{nextIdx}]{machineStates[nextIdx]['codes']}\n")
    ...
    print(f"Phases {phases}: lastOutput={lastOutput}")
